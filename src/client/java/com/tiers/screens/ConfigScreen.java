...
public class ConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        if (ownProfile.status == Status.READY) {
            ...
            enableOwnProfile = ButtonWidget.builder(Text.of("⚠"), (buttonWidget) -> {}).dimensions(width - 20 - 5 - 88 - 4, height - 20 - 5, 20, 20).tooltip(Tooltip.of(Text.of("Can't switch profiles: use a version of Tiers for 1.20.3+"))).build();
