...
public class ConfigScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTextWithShadow(this.textRenderer, TiersClient.getRightIcon(), centerX + 90 + 33, distance + 75 + 8, ColorControl.getColor("text"));
        context.drawTextWithShadow(this.textRenderer, TiersClient.getLeftIcon(), centerX - 90 - 33 - 12, distance + 75 + 8, ColorControl.getColor("text"));
