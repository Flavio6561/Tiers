...
public class ConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        if (ownProfile.status == Status.READY) {
            ...
            enableOwnProfile = ButtonWidget.builder(Text.of("Cannot switch profiles"), (buttonWidget) -> {}).dimensions(width / 2 - 90, distance + 75, 180, 20).tooltip(Tooltip.of(Text.of("Can't switch profiles: use a version of Tiers for 1.20.3+"))).build();
